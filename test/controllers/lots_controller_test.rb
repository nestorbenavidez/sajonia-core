...
class LotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lot" do
    assert_difference('Lot.count') do
      post lots_url, params: { lot: { certification: @lot.certification, damage: @lot.damage, imperfection: @lot.imperfection, name: @lot.name, quality: @lot.quality, variety: @lot.variety } }
    end
  ...
  test "should update lot" do
    patch lot_url(@lot), params: { lot: { certification: @lot.certification, damage: @lot.damage, imperfection: @lot.imperfection, name: @lot.name, quality: @lot.quality, variety: @lot.variety } }
